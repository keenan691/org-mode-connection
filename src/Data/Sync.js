...
const groupByChanged_and_Not_Changed = R.groupBy(
...
const zipNotChanged_ToDbAndFilePairs =  R.over(
...
export const getChanges = (file) => {
  ...
  if (newExternalMtime) remoteChanges = promisePipe(
    ...
    groupByChanged_and_Not_Changed,
    zipNotChanged_ToDbAndFilePairs)(file)
